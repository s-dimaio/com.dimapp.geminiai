    ...
    try {
      ...
      switch (name) {
        ...
        case 'discover_devices': // Backward-compatible alias
          if (args.query) {
            return await this.discoveryManager.searchDevices(args.query, args.includeHiddenGrouped);
          }
          ...
          if (args.zoneName && args.deviceClass) {
            return await this.discoveryManager.listDevicesByClassInZone(args.deviceClass, args.zoneName, args.includeHiddenGrouped);
          } else if (args.zoneName) {
            return await this.discoveryManager.listDevicesInZone(args.zoneName, args.includeHiddenGrouped);
          } else if (args.deviceClass) {
            return await this.discoveryManager.listDevicesByClass(args.deviceClass, args.includeHiddenGrouped);
          }
          return await this.discoveryManager.listAllDevices(args.includeHiddenGrouped);
        case 'list_zones':
          return await this.discoveryManager.listZones();
        case 'get_home_summary':
          if (args.deviceClass) {
            return await this.discoveryManager.getDevicesStatusByClass(args.deviceClass, args.zone || null, args.includeHiddenGrouped);
          } else if (args.zone) {
            return await this.discoveryManager.getDeviceCountByZone(args.zone, args.includeHiddenGrouped);
          }
          return await this.discoveryManager.getDeviceCountByZone(null, args.includeHiddenGrouped);

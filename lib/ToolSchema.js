        ...
        },
        {
            ...
            description: `
                ...
                **Response Format:**
                ...
                - Returns: \`unavailableDevices\` (array of \`{ name, zone, class }\` objects). Use this field to instantly check if any device is offline or has connection issues in the home (or in the queried zone) with very low token overhead.
